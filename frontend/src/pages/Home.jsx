  ...
  return (
    ...
    >
      <img
        ...
        alt="Library"
        style={{ width: "100%", maxWidth: 500, borderRadius: 16, marginBottom: 24, boxShadow: "0 2px 8px rgba(0,0,0,0.12)" }}
      />
      <h1 style={{ color: "#2575fc", fontSize: "2.5em", marginBottom: 16 }}>
        Welcome to GoodLuck Study Library <span role="img" aria-label="books">📚</span>
      </h1>
      <p style={{ fontSize: 20, color: "#333", marginBottom: 8 }}>Calm & Silent Environment</p>
      <h3 style={{ color: "#198754", marginBottom: 16 }}>Helpline: +91 9636590409</h3>
      ...
      <div style={{ display: "flex", gap: 24, marginTop: 16 }}>
        <img
          ...
          alt="Study Area"
          style={{ width: 180, height: 120, objectFit: "cover", borderRadius: 12, boxShadow: "0 2px 8px rgba(0,0,0,0.10)" }}
        />
        <img
